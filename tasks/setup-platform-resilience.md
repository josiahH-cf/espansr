...
- **Criteria covered:** `get_platform()` and `get_platform_config()` are cached with `@lru_cache` and return identical objects on repeat calls; all existing tests pass without modification.
- **Status:** [ ] Not started
